...
> This project is purely vibe-driven. Feel free to fork it, inject your own creativity, and keep the vibe coding going!
...
- **📺 多层景深 (Multi-Layer Depth)**: 5层不同缩放和速度的代码流，营造出真实的空间感。
- **📜 古诗词融入 (Chinese Classics)**: 代码雨中随机出现《道德经》、《论语》、唐诗宋词等名句，且阅读顺序由上至下，具有连贯性。
- **🔴 故障流效果 (Glitch Streams)**: 5% 的概率出现红色的“故障”代码流，下落速度更快，增加视觉冲击力。
- **🧩 周期性警语 (Periodic Mosaic)**: 每隔 15-30 秒，代码雨会汇聚成一句极具科幻感的中文警语（如“勺子不存在”、“系统即将崩溃”）。
- **🔠 中英混合 (Mixed Characters)**: 完美融合了 ASCII 字符与常用汉字。
- **⚡️ 高性能渲染 (High Performance)**: 采用原生 Objective-C 与 Cocoa 框架开发，60 FPS 流畅运行，低 CPU 占用。
- **📏 智能适配 (Smart Layout)**: 自动适配不同屏幕分辨率，支持文字自动换行与缩放。

---

## 🚀 快速安装 | Quick Installation

### 方法一：直接下载 (Direct Download)
